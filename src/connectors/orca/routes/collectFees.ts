...
const CollectFeesResponseSchema = Type.Object({
  signature: Type.String(),
});

class CollectFeesController extends OrcaController {
  private collectFeesResponseValidator = TypeCompiler.Compile(CollectFeesResponseSchema);
